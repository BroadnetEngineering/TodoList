        ...
        <div class="row justify-content-center">
                <form action="crud.php" method="POST">
                    ...
                    <div class="form-group" style="text-align:center;">
                        <h2 style="margin-top:2rem;"><strong>My Todo List</strong></h2>
                    ...
                    <?php else: ?>
                        <button class="btn btn-success" type="submit" name="save" disabled>Save</button>
                    <?php endif; ?>
                    </div>
                </form>
        </div>
                ...
                <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="crud.php?delete=<?php echo $row["id"]; ?>">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
